...
#################################################
## Dico ==> migrated to Native Agnostep apps
...
###########################################################################
### Moved to UpMem into Native Agnostep apps
###########################################################################
### Memory app
...
#################################################
## SaveLink ==> Migrated into Native Agnostep Apps
### Provided by AGNoStep Project
#################################################
...
#################################################
## TestCuckoo ==> Migrated to Sound.app into 
## Native Agnostep apps
### Provided by AGNoStep Project
#################################################
