...
1) Use the main script to launch the **AgnostepManager**:
...
3) In the menu **Utilities**: select (check) the desired apps to install. Validate: press the button **OK**.

### List of Utilities available

- Affiche: Sticky Notes
- Calculator
- DictionaryReader: Dictionary Lookup for the English Users
- FontManager
- FTP: a FTP client
